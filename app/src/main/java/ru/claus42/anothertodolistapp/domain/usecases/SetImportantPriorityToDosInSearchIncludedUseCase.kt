...
class SetImportantPriorityToDosInSearchIncludedUseCase @Inject constructor(
    ...
    suspend operator fun invoke(included: Boolean) {
        return searchOptionsPreferencesRepository.setImportantPriorityTodosIncluded(included)
    }
}